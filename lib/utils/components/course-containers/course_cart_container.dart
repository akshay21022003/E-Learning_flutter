...
Widget courseCartContainer({
  ...
  required int index,
  required DismissDirectionCallback dismissDirectionCallback
}) {
  return GestureDetector(
    onTap: () {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => DetailsScreen(courseModel: courseModel),
        ),
      );
    },
    child: Dismissible(
      key: ValueKey<String>(courseModel.id!),
